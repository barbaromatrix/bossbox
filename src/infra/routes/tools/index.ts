...
toolRouter
  .get('/tools',
    checkForValidToken(),
    requestValidation({ schema: getToolsRequest, requestType: 'query' }),
  ...
  .post('/tools',
    checkForValidToken(),
    requestValidation({ schema: createToolsRequest, requestType: 'body' }),
    async (req: Request, res: Response) => {
      try {
  ...
  .delete('/tools/:id',
    checkForValidToken(),
    requestValidation({ schema: deleteToolRequest, requestType: 'params' }),
    async (req: Request, res: Response) => {
      try {
